...
export const SAMPLE_ARTICLES: Article[] = [
  {
    ...
    subtitle:
      "Subsidies cannot substitute for proprietary silicon fabrication. An investigation into the struggle to decouple critical infrastructure from foreign hyperscalers.",
    author: {
    ...
    sections: [
      {
        ...
        type: "lead",
        content:
          "Ministers across the continent repeat a comforting thesis: with enough public capital and domestic data centers, autonomy over artificial intelligence is within reach. The reality on factory floors tells a different story.",
      },
      {
        id: "s2",
        type: "data-callout",
      ...
      },
      {
        ...
        type: "paragraph",
        content:
          "True sovereignty begins at the nanometer level. Advanced pipelines require EUV optics and high-bandwidth packaging that cannot simply be re-engineered through directives.",
      },
      {
        id: "s5",
        type: "quote",
        content:
          "You can mandate that data resides locally, but if the processing units are subject to foreign export controls, sovereignty is a fiction.",
  ...
  },
  {
    ...
    subtitle:
      "Six hundred meters beneath granite peaks, subterranean pumped-storage facilities have become Europe's most indispensable renewable energy shock absorbers.",
    author: {
      name: "Marcus Tanner",
    ...
    sections: [
      {
        ...
        type: "lead",
        content:
          "Inside the mountain rock above Martigny, the roar of six reversible pump-turbines vibrates through the bedrock. This is Nant de Drance: capable of storing potential energy for four hundred thousand households within minutes.",
      },
      {
        id: "ab-2",
        type: "data-callout",
      ...
      },
      {
        ...
        type: "quote",
        content:
          "The transition is not merely about producing green electrons; it is about storing them until humanity needs them.",
  ...
  },
  {
    ...
    subtitle:
      "CRISPR-edited wheat variants demonstrate a forty percent reduction in transpiration during southern European heatwaves.",
    author: {
      name: "Chiara Rossi",
    ...
    sections: [
      {
        ...
        type: "lead",
        content:
          "After three consecutive record-dry summers across Lombardy, harvest data from experimental cereal fields has delivered rare optimism for Mediterranean food security.",
      },
      {
        id: "dg-2",
        type: "quote",
        content:
          "Targeted stomatal regulation allowed the plants to sustain photosynthetic output even through 39-degree afternoon peaks.",
